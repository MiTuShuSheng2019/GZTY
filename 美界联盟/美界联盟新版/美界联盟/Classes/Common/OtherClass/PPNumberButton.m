...
- (void)setupUI
{
    ...
    _increaseBtn.backgroundColor = RGB(32, 135, 238);
    _decreaseBtn.backgroundColor = RGB(32, 135, 238);
    [_increaseBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [_decreaseBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
