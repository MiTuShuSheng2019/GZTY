//
//  TYDeliverGoodsViewController.m
//  美界联盟
//
...
@interface TYDeliverGoodsViewController ()<UITableViewDelegate, UITableViewDataSource>
@property (weak, nonatomic) IBOutlet UITableView *myTableView;

@end

@implementation TYDeliverGoodsViewController
...
-(void)requestGetCusSumOutData{
    ...
    NSString *url = [NSString stringWithFormat:@"%@mapi/mpsi/GetCusSumOutData",APP_REQUEST_URL];
