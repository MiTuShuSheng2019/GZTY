...
#define ForegroundStarImage @"stars_choose"
#define BackgroundStarImage @"stars_ acquiescence"

typedef void(^completeBlock)(CGFloat currentScore);

@interface TYcommentGradeView()
...
@implementation TYcommentGradeView
...
-(instancetype)initWithFrame:(CGRect)frame numberOfStars:(NSInteger)numberOfStars rateStyle:(RateStyle)rateStyle isAnination:(BOOL)isAnimation delegate:(id)delegate{
    if (self = [super initWithFrame:frame]) {
        [self setNumberOfStars:numberOfStars rateStyle:rateStyle isAnination:isAnimation delegate:delegate];
    }
    return self;
}
...
-(instancetype)initWithFrame:(CGRect)frame numberOfStars:(NSInteger)numberOfStars rateStyle:(RateStyle)rateStyle isAnination:(BOOL)isAnimation finish:(finishBlock)finish{
    if (self = [super initWithFrame:frame]) {
        [self setNumberOfStars:numberOfStars rateStyle:rateStyle isAnination:isAnimation delegate:finish];
    }
    return self;
}
...
-(void)layoutSubviews {
    ...
    __weak TYcommentGradeView *weakSelf = self;
